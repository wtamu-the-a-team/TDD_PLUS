...
class NewVisitorTest(LiveServerTestCase):
    ...
    def test_can_start_a_form_for_one_user(self):
        ...
        # She notices the page title and header mention to-do forms
        ...
        # "1: Buy peacock feathers" as an item in a to-do form table
		...
		# She visits that URL - her to-do form is still there.

		# Satisfied, she goes back to sleep

    def test_multiple_users_can_start_forms_at_different_urls(self):
        # Edith starts a new to-do form
        self.browser.get(self.live_server_url)
        inputbox = self.browser.find_element_by_id('id_new_item')
        inputbox.send_keys('Buy peacock feathers')
        inputbox.send_keys(Keys.ENTER)
